                ...
                <div class="collapse navbar-sm-collapse" >{{--上面按鈕欄--}}
                    <ul class="nav navbar-sm-nav">{{--上面按鈕欄內容 靠左對齊--}}
                        ...
                        {!! Form::open(array('url' => 'victim/EMT/update'))!!}
                            {!! Form::select('sex', array('' => '性別', '男' => '男', '女' => '女'), '性別', ['class' => 'navbar-sm-btn btn-sm sex','id' => 'sex']) !!}
                            {!! Form::select('damage_level', array('' => '傷重程度','0' => '正常','1' => '輕傷','2' => '中傷', '3' => '重傷','4' => '死亡'),'傷重程度',['class' => 'navbar-sm-btn btn-sm','id' => 'damage_level']) !!}
                            {!! Form::select('now_location', $now_locations,'',['class' => 'navbar-sm-btn btn-sm','id' => 'now_location']) !!}
                            {!! Form::text('name','',['placeholder'=>' 姓名','style'=>'width:120px;border: 1px solid #cccccc; border-radius: 4px;height: 30px;','id' => 'name']) !!}
                            {!! Form::text('phone','',['placeholder'=>' 電話','style'=>'width:240px;border: 1px solid #cccccc; border-radius: 4px;height: 30px;','id' => 'phone']) !!}
                            {!! Form::text('person_id','',['placeholder'=>' 身分證字號','style'=>'width:240px;border: 1px solid #cccccc; border-radius: 4px;height: 30px;','id' => 'person_id']) !!}
    ...
    <script>
        ...
        function updateTable(victimData){
            ...
            for(var i=0; i<DataLength; i++){
                ...
                td.innerHTML = victimData[i]['victim_detail_id'];
                tr.appendChild(td);
                var td = document.createElement('td');
                ...
                button.setAttribute("data-target","#update"+victimData[i]['victim_detail_id']);
                button.innerHTML = "詳細/修改";
